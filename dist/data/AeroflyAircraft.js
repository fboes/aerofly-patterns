...
export class AeroflyAircraftFinder {
     ...
     */
    static get(aeroflyAircraftCode) {
        ...
        const callsign = aircraft.icaoCode
            ? "N" +
                ...
                AeroflyAircraftFinder.randomizedLetter(aircraft.icaoCode.charCodeAt(0)), AeroflyAircraftFinder.randomizedLetter(aircraft.icaoCode.charCodeAt(3)), AeroflyAircraftFinder.randomizedLetter(aircraft.icaoCode.charCodeAt(2)))
            : "N0XXX";
    ...
    static getRunwayLengths(aircraft) {
        let runwayTakeoff = null;
        let runwayLanding = null;
