...
export const MissionTypes = {
    ...
    medEvac: {
        ...
        description: "Fly to the specified location to drop off your emergency doctor / paramedic and take a patient on board if necessary. Afterwards fly to ${destination}.",
        objects: [
            {
                xref: "ambulance",
                light: {
    ...
    lostPerson: {
        ...
        description: "Fly to the specified location and locate the person in distress. You will need to drop off your emergency doctor / paramedic and take the person on board. Afterwards fly to ${destination}.",
        objects: [
            {
    ...
    ship: {
        ...
        description: "Fly to the specified ship's position to drop off your emergency doctor / paramedic and take a patient on board. Afterwards fly to ${destination}.",
        objects: [
            {
                xref: "police_car",
                light: {
    ...
    car: {
        ...
        description: "Fly to the specified car accident site to drop off your emergency doctor / paramedic and take a patient on board. Afterwards fly to ${destination}.",
        objects: [
            {
                xref: "police_car",
                light: {
...
export const MissionTypeFinder = {
     ...
     * @returns {MissionType}
     */
    _quickMission(accidentType, objects = [
        {
            xref: "ambulance",
            light: {
                height: 3,
