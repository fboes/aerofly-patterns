...
Expect further clearance at ${efcString}.`;
    ...
    _makeOriginPosition(pattern, bearing) {
    ...
    _makeDestinationPosition(pattern) {
        return {
            icao: this.weather.icaoId,
    ...
    _getCheckpoints(pattern, patternEntry) {
    ...
    _getEntryCheckpoints(pattern, patternEntry) {
